...
@everywhere function LQ(A::MF, B::MF, a::MF, b::MF, Q::MF, R::MF, N::Int)
	# Also needed for LQR
...
@everywhere function LQ(A::VMF, B::VMF, a::MF, b::MF, Q::MF, R::MF, N::Int)
...
@everywhere function LQ(K::VMF, Ginv::VMF, A::VMF, B::VMF, a::MF, b::MF, Q::MF, R::MF, N::Int)
...
# used in linear pto
@everywhere function LQ2(A::VMF, B::VMF, Q::MF, R::MF, N::Int)
	# Also needed for LQR
    P = Array{Matrix{Float64}}(N+1)
    G = Array{Matrix{Float64}}(N)
...
@everywhere function apply_LQ_gains(A::MF, B::MF, K::Vector{MF}, C::VVF)
	N = length(K)
...
@everywhere function apply_LQ_gains(A::VMF, B::VMF, K::VMF, C::VVF)
	N = length(K)
