...
# """
@everywhere mutable struct ConstantInitializer <: Initializer
	action::Vector{Float64}
end


@everywhere function initialize(ci::ConstantInitializer, gpm::GaussianProcessManager, tm::TrajectoryManager)
