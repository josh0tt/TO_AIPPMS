...
rmse_hist_gcb = readdlm("/data/ssh/Rover/budget_100/rmse_hist_gcb.csv", ',')
rmse_hist_basic = readdlm("/data/ssh/Rover/budget_100/rmse_hist_basic.csv", ',')
rmse_hist_raster = readdlm("/data/ssh/Rover/budget_100/rmse_hist_raster.csv", ',')
rmse_hist_gp_mcts = readdlm("/data/ssh/Rover/budget_100/rmse_hist_gp_mcts.csv", ',')
...
if use_ssh_dir
	savefig("/data/figures/RMSE_traj_together.pdf")
else
	savefig("/data/ssh/Rover/budget_100/RMSE_traj_together.pdf")
end
