...
@with_kw mutable struct RoverPOMDP <: POMDP{RoverState, Symbol, Float64} # POMDP{State, Action, Observation}
    ...
    σ_drill::Float64                       = σ_drill
    σ_spec::Float64                        = σ_spec
    drill_time::Float64                    = sample_cost #3.0 # takes 10 time units to drill vs. 1.0 to move to neighbor cell TODO: include uncertain drill time
    cost_budget::Float64                   = total_budget#300.0
