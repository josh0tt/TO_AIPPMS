...
trace_hist_gcb = readdlm("/data/ssh/Rover/budget_100/trace_hist_gcb.csv", ',')
trace_hist_basic = readdlm("/data/ssh/Rover/budget_100/trace_hist_basic.csv", ',')
trace_hist_raster = readdlm("/data/ssh/Rover/budget_100/trace_hist_raster.csv", ',')
trace_hist_gp_mcts = readdlm("/data/ssh/Rover/budget_100/trace_hist_gp_mcts.csv", ',')
...
if use_ssh_dir
	savefig("/data/figures/trace_traj_together.pdf")
else
	savefig("/data/ssh/Rover/budget_100/trace_traj_together.pdf")
end
