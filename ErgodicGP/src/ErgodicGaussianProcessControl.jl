...
# ergodic manager
include("ergodicGP_manager/domain.jl")
include("ergodicGP_manager/ergodicGP_manager.jl")
include("ergodicGP_manager/r2.jl")
# include("gaussian_process_manager/r3.jl")
# include("gaussian_process_manager/r2t.jl")
# include("gaussian_process_manager/se2.jl")
# include("gaussian_process_manager/examples.jl")
