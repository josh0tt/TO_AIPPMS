...
@everywhere function smc_trajectory(em::ErgodicGPManagerR2, tm::TrajectoryManager; verbose::Bool=true, umax::Float64=1.0)
...
@everywhere function compute_B(em::ErgodicGPManagerR2, xd::VVF, n::Int, h::Float64, ck::Matrix{Float64})
