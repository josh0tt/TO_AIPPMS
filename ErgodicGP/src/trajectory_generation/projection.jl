...
@everywhere function project(egpm::ErgodicGPManager, tm::TrajectoryManager, K::VMF, xd::VVF, ud::VVF, zd::VVF, vd::VVF, step_size::Float64)
	xdn = [xd[1]]
	...
	alpha = Vector{Vector{Float64}}(undef, length(xd))#VVF(tm.N + 1) 
...
@everywhere function project(egpm::ErgodicGPManager, tm::TrajectoryManager, sad::MF, sample_actions::VF, step_size::Float64)
...
@everywhere function project2(egpm::ErgodicGPManager, tm::TrajectoryManager, K::VMF, xd::VVF, ud::VVF, zd::VVF, vd::VVF, step_size::Float64)
	xdn = [xd[1]]
